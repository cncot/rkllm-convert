"""
Convert Qwen3-4B-Instruct-2507 to RKLLM format for RK3588 NPU — W4A16 (INT4) variant.
32K context using patched RKLLM toolkit v1.2.3.

Difference from original export_rkllm_qwen3.py:
  quantized_dtype = "W4A16"   (was "W8A8")
  Expected output: ~2.4GB, 10-15 t/s  (was ~4.7GB, ~5 t/s)
"""
...
quantized_dtype = "W4A16"            # ← 关键改动: W8A8 → W4A16 (INT4)
